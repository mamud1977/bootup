...
class Dog(Animal):
    ...
    def __init__(self, name, age):
        ...
        self.name = name
        self.age = age
        Dog.object_count = Dog.object_count + 1
...
print('Dog.object_count: ',Dog.object_count)
print('dog1.object_count: ',dog1.object_count)
print('dog2.object_count: ',dog2.object_count)
